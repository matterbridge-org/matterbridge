...
func (b *Bmatrix) Send(msg config.Message) (string, error) {
	...
	msgID, err := b.sendNormalMessage(roomID, body, formattedBody, username, config.Message(msg))
	if err != nil {
		return "", err
	}
...
func (b *Bmatrix) handleUploadFiles(msg *config.Message, roomID id.RoomID) (string, error) {
	if msg.Text != "" {
		...
		// TODO: message ID
		_, err := b.sendNormalMessage(roomID, body, formattedBody, username, config.Message(msg))
		if err != nil {

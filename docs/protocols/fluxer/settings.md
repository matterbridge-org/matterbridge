...
Third party instance's API requests URL.

- Setting: **OPTIONAL**
- Format: *string*
- Example:
  ```toml
  BaseURL="https://api.my-fluxerserver.local"
  ```

## GatewayURL

Third party instance's Gateway URL.

- Setting: **OPTIONAL**
- Format: *string*
- Example:
  ```toml
  GatewayURL="wss://gateway.my-fluxerserver.local"
  ```

## UGCUrl

Third party instance's UGC URL.

- Setting: **OPTIONAL**
- Format: *string*
- Example:
  ```toml
  BaseURL="https://ugc.my-fluxerserver.local"
  ```
...
If not specified, all mentions are not allowed. Note that even when a mention
is not allowed, it will still be displayed nicely and be clickable. It just

...
- general
  ...
  - new bridge functions "SetString" and "SetInt" have been added, which provide override values for the Viper config settings for that bridge.  These settings do not persist upon restart.
- irc
